---
description: This skill should be used when the user reports "daemon won't start", "daemon timeout", "server not responding", "timed out waiting for healthy state", "stale daemon", or mentions daemon troubleshooting issues.
---

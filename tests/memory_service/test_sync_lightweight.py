...
# All tests in this module use await_idle=True which can be slow in CI
# due to resource contention with parallel workers
pytestmark = pytest.mark.slow_threshold(10.0)

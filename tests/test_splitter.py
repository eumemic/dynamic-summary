...
class TestTextSplitter:
    ...
    def test_split_basic_text(self):
        ...
        index_config = IndexConfig(target_chunk_tokens=50, prev_context_tokens=25)
    ...
    def test_adjacent_context(self):
        ...
        index_config = IndexConfig(target_chunk_tokens=50, prev_context_tokens=10)
        splitter = TextSplitter(index_config)
    ...
    def test_token_counting(self):
        ...
        index_config = IndexConfig(target_chunk_tokens=200, prev_context_tokens=75)
        splitter = TextSplitter(index_config)

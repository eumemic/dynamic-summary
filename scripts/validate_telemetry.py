...
class TelemetryValidator:
    ...
    def _validate_format_version(self, telemetry: dict) -> None:
    ...
    def _validate_documents(self, telemetry: dict) -> None:
    ...
    def _validate_nodes(self, telemetry: dict) -> None:
    ...
    def _validate_embedding(self, embedding: dict, path: str) -> None:
    ...
    def _validate_summary_attempt(self, attempt: dict, path: str) -> None:
    ...
    def _validate_metadata(self, metadata: dict, nodes: list, doc_type: str) -> None:
    ...
    def _validate_consistency(self, telemetry: dict) -> None:
...
def validate_directory(dir_path: Path, validator: TelemetryValidator) -> None:
    ...
    print(f"  Valid files: {sum(1 for f in json_files if validator.validate_file(f)[0])}")

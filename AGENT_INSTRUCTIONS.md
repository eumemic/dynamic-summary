...
- **Never Commit to Master:** Always ensure you're on a feature branch before committing. Check with `git branch --show-current`. If on master/main, create a feature branch first. If unsure about the branch name, ask the user what feature you're about to work on.

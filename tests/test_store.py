...
class TestStore:
    ...
    def test_dirty_marking(self, temp_store):
        ...
        assert child_node.is_dirty == 1
        assert parent_node.is_dirty == 1
        assert root_node.is_dirty == 1
...
This file converts the core assembly tests from test_dp_assembly.py to use
the real in-memory SQLite backend instead of SimpleMockStore, providing
higher fidelity testing of the DP assembly functionality.

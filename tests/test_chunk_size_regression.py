"""Backend-agnostic chunk sizing regression tests using the runtime harness."""
...
class TestChunkSizeRegression:
    """Run chunk sizing checks against the default in-memory backend."""
    ...
    async def test_indexed_chunks_have_correct_size(
        ...
        test_doc = build_test_document(50)
